...
evsys_init: ; get EVSYS base address
            ...
            ldi     TEMP0, CONFIG_EVSYS_ASYNCCH0    ; get config constant
            st      X+, TEMP0                       ; write into register

            ; configure register Asynchronous Channel 1 Generator Selection
            ldi     TEMP0, CONFIG_EVSYS_ASYNCCH1    ; get config constant
            st      X+, TEMP0                       ; write into register
            ...
            ldi     TEMP0, CONFIG_EVSYS_ASYNCUSER0  ; get config constant
            st      X+, TEMP0                       ; write into register

            ; configure register Asynchronous User Channel 1 Input Selection
            ldi     TEMP0, CONFIG_EVSYS_ASYNCUSER1  ; get config constant
            st      X+, TEMP0                       ; write into register
